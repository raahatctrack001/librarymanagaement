...
const OverDueBooks = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('/api/v1/loan/get-overdue-loan', {method: 'GET'}); // Assuming /api/books is the endpoint for fetching books
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-400">
      ...
      (<h2 className="text-2xl font-bold mb-4"> No Over due yet </h2>)}
